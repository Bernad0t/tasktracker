...
const OneTask = memo(function({task}: {task: TaskDTORelation}){
    ...
    return( // при клике открой модальное окно, где будет вся инфа + коммы
        <>
        <div
...
export default function TaskTypeWrapper({tasks, statusName}: {tasks: TaskDTORelation[], statusName: keyof typeof StatusTask}){
