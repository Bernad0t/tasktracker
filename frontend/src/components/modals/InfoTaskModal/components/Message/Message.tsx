...
export function MessageBase({message, className, name}: {message: CommentsDTO, className?: string, name?: string}){
...
export function ForeignAccauntMessage({message, user}: {message: CommentsDTO, user: UserDataDTO | undefined}){
    return(
