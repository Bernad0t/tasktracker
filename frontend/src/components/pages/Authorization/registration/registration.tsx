import {
    initialRegisrationProp,
    RegisrationProp,
} from '../../../../entities/schemas/dto/authorizationDTO';
            ...
            <AuthorizationBaseForm isEnter={false}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <LoadingComponent loading={isLoading}>
                        {Object.keys(initialRegisrationProp).map(key => (
                        ...
                        <AuthorizationBatton
                            ...
                            style={{
                                marginTop: '20px',
                                backgroundColor: isLoading ? '#0055C3' : undefined,
                            }}
                            disabled={isLoading}
                        >
                            Зарегистрироваться
                        ...
                        <WayAuthorization
                            nameLink="Войти"
                            nameQuestion="Есть аккаунт?"
                            callback={() => navigate(core.frontendEndpoints.login)}
                        />
                        <div>
